...
DIST_COMMON = README $(am__configure_deps) $(include_HEADERS) \
	...
	$(srcdir)/config.h.in $(srcdir)/pHash.pc.in \
...
ACLOCAL = ${SHELL} /home/eklinger/pHash/trunk/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/eklinger/pHash/trunk/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/eklinger/pHash/trunk/missing --run autoconf
AUTOHEADER = ${SHELL} /home/eklinger/pHash/trunk/missing --run autoheader
AUTOMAKE = ${SHELL} /home/eklinger/pHash/trunk/missing --run automake-1.10
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/eklinger/pHash/trunk/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NMEDIT = 
OBJEXT = o
PACKAGE = pHash
...
abs_top_srcdir = /home/eklinger/pHash/trunk
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /home/eklinger/pHash/trunk/install-sh
...
test_video$(EXEEXT): $(test_video_OBJECTS) $(test_video_DEPENDENCIES) 
	@rm -f test_video$(EXEEXT)
	$(CXXLINK) $(test_video_OBJECTS) $(test_video_LDADD) $(LIBS)
...
include ./$(DEPDIR)/audiophash.Plo
include ./$(DEPDIR)/pHash.Plo
include ./$(DEPDIR)/test_audiophash.Po
include ./$(DEPDIR)/test_imagephash.Po
include ./$(DEPDIR)/test_videophash.Po
